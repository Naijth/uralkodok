// define the header of the table as an object
const header = { // this is a complex variable representing the header labels for the table
...
const line7 = { // this is an object representing the seventh data row
...
th1.innerHTML = header.uralkodo; // sets the text of th1 to the variable uralkodo's content
...
th2.innerHTML = header.esemeny; // sets the text of th2 to the variable esemeny's content
...
th3.innerHTML = header.evszam; // sets the text of th3 to the variable evszam's content
...
td4.innerHTML = line2.esemeny; // sets the text of td4 to the event name
const td5 = document.createElement('td'); // creates a table cell for the year
tr3.appendChild(td5); // appends td5 to tr3
td5.innerHTML = line2.evszam; // sets the text of td5 to the year
...
td12.innerHTML = line5.esemeny; // sets the text of td12 to the event name
const td13 = document.createElement('td'); // creates a table cell for the year
tr6.appendChild(td13); // appends td13 to tr6
td13.innerHTML = line5.evszam; // sets the text of td13 to the year
...
td17.innerHTML = line7.esemeny; // sets the text of td17 to the event name
const td18 = document.createElement('td'); // creates a table cell for the year
tr8.appendChild(td18); // appends td18 to tr8
td18.innerHTML = line7.evszam; // sets the text of td18 to the year